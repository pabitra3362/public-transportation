    ...
    <div className="py-2">
          ...
          <div className="flex justify-between items-center py-4 rounded-lg bg-yellow-400 px-2">
            <div className="flex items-center gap-3">
                <img className="h-8 w-8 rounded-full object-cover" src="https://www.shutterstock.com/image-photo/portrait-smiling-young-girl-making-260nw-436447678.jpg" alt="driver-image" />
