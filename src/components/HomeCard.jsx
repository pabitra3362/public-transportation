...
const HomeCard = ({icon,title,description}) => {
  return (
    <div className='group w-80 bg-white md:bg-slate-200  rounded-lg h-80 hover:shadow-2xl hover:-translate-y-5 transition duration-300 relative grid items-center gap-2 px-3 p-5'>
